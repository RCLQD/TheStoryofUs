  ...
  return (
    ...
    >
      ...
      {images.map((img, index) => {
        ...
        return(
          <div key={index} data-mouse-move-index={index} className="h-40 w-32 bg-white rounded-xl border-[1.5px] border-black pointer-events-none absolute left-0 top-0 object-cover opacity-0 p-4 shadow-xl">
